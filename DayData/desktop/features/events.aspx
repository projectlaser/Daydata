<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="events.aspx.cs" Inherits="DayData.desktop.features.events" %>
...
<script type="text/javascript">
    ...
    <form id="form1" runat="server">
     ...
     <div class="box-header"><span class="glyph calendar"></span><h1>Events for <asp:Label ID="todayLabel" runat="server"></asp:Label></h1></div>
