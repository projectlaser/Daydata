<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scoreboard.aspx.cs" Inherits="DayData.desktop.features.scoreboard" %>
...
<script type="text/javascript">
    ...
    <form id="form1" runat="server">
     ...
     <div class="box-header"><span class="glyph calendar"></span><h1>Scoreboard for <asp:Label runat="server" id="dateLabel"></asp:Label></h1></div>
     <table class="table">
     <tbody>
