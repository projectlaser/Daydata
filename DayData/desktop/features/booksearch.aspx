<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="booksearch.aspx.cs" Inherits="DayData.desktop.features.booksearch" %>
...
<script type="text/javascript">
    ...
    <form id="form1" runat="server">
     ...
     <div class="tiles">
     <div class="section">
     <a style="float:left" class="nav_back" href="../default.aspx"></a>
          <div class="box center">
     <div class="box-header"><span class="glyph calendar"></span><h1>INFORMATION</h1></div>
         <div class="box-content">
     <h1>Attention: The book search feature will be up soon. Please stay tuned!</h1>
     </div>
     </div>
     </div>
     </div>
