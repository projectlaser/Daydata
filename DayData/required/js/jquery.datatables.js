	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input class="searcher" type="text" placeholder="Search..." />') :
			  sSearchStr === "" ? '<input class="searcher" type="text" placeholder="Search..." />' : sSearchStr + ' <input class="searcher" type="text" placeholder="Search..." />';
