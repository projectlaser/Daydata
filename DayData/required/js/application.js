    ...
    function init() {
        ...
        ***********/
        ...
        $('#calendar').fullCalendar({
            events: "../../../../required/json/EventJson.ashx",
            editable: false,
            selectable: true,
            ...
            eventMouseover: function (event, jsEvent, view) {
                ...
                var moveDown = 10;
                $('#event_popup').show();
                $("div#event_popup").css('top', jsEvent.pageY + moveDown).css('left', jsEvent.pageX + moveLeft);
            },
            eventMouseout: function () {
                $('#event_popup').hide();
            },
            dayClick: function (date, allDay, jsEvent, view) {
                window.location = "new_event.aspx?date=" + date.toDateString();
            }
        });
